...
function App() {
  ...
  const [patientBio, setPatientBio] = useState({
    id: 'PATDHCS2001457',
    name: 'Rishav Kumar',
    birthDate: '22 sep 2001',
    phoneNumber: '987564231',
    _address: 'K L University, green feilds, Vaddeswaram, Vijayawada, Andhra Pradesh',
  })
  const [patientMedicalData, setPatientMedicalData] = useState({
    ...
    diseaseDescription:
      'caused by sudden change in weather',
    diseaseStartedOn: '1 sep 2022',
  })
